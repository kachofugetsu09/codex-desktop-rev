// 004168f0  undefined _RNvMs3_NtCskPe9mFtgPYj_5alloc7raw_vecINtB5_6RawVecNtNtCs14svwdtrmj2_24tectonic_engine_spx2html8fontfile17HorizontalMetricsE8grow_oneBQ_(void)

void _RNvMs3_NtCskPe9mFtgPYj_5alloc7raw_vecINtB5_6RawVecNtNtCs14svwdtrmj2_24tectonic_engine_spx2html8fontfile17HorizontalMetricsE8grow_oneBQ_
               (ulong *param_1)

{
  ...
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs14svwdtrmj2_24tectonic_engine_spx2html_llvm_4308007309237878366
            (aiStack_28,*param_1,param_1[1],uVar11,2,4);
  if (aiStack_28[0] != 1) {
    param_1[1] = (ulong)puStack_20;
    *param_1 = uVar11;
    return;
  }
  puStack_30 = &UNK_00416954;
  ...
  puStack_58 = &UNK_0041699a;
  puStack_38 = param_1;
  puStack_30 = (undefined *)uVar11;
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs14svwdtrmj2_24tectonic_engine_spx2html_llvm_4308007309237878366
            (aiStack_50,*puStack_20,puStack_20[1],uVar10,8,0x28);
  if (aiStack_50[0] != 1) {
    puStack_20[1] = (ulong)puStack_48;
    *puStack_20 = uVar10;
    return;
  }
  puStack_58 = &UNK_004169c4;
  ...
  puStack_80 = &UNK_00416a0a;
  puStack_58 = (undefined *)uVar10;
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs14svwdtrmj2_24tectonic_engine_spx2html_llvm_4308007309237878366
            (aiStack_78,*puStack_48,puStack_48[1],uVar11,4,8);
  if (aiStack_78[0] != 1) {
    puStack_48[1] = (ulong)puStack_70;
    *puStack_48 = uVar11;
    return;
  }
  puStack_80 = &UNK_00416a34;
  ...
  puStack_a8 = &UNK_00416a7a;
  puStack_80 = (undefined *)uVar11;
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs14svwdtrmj2_24tectonic_engine_spx2html_llvm_4308007309237878366
            (aiStack_a0,*puStack_70,puStack_70[1],uVar10,4,4);
  if (aiStack_a0[0] != 1) {
    puStack_70[1] = (ulong)puStack_98;
    *puStack_70 = uVar10;
    return;
  }
  puStack_a8 = &UNK_00416aa4;
  puVar5 = puStack_98;
  (*(code *)PTR__RNvNtCskPe9mFtgPYj_5alloc7raw_vec12handle_error_01815f30)(puStack_98,uStack_90);
  uVar3 = *puVar5 * 2;
  uVar11 = 4;
  if (4 < uVar3) {
    uVar11 = uVar3;
  ...
  uVar8 = 2;
  uVar3 = uVar11;
  puStack_a8 = (undefined *)uVar10;
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs14svwdtrmj2_24tectonic_engine_spx2html_llvm_4308007309237878366
            (aiStack_c8,*puVar5,puVar5[1]);
  if (aiStack_c8[0] != 1) {
    puVar5[1] = (ulong)puStack_c0;
    *puVar5 = uVar11;
    return;
  }
  puVar6 = puStack_c0;
  ...
  if (lStack_b8 == 0) {
    ...
    lVar4 = (*(code *)PTR__RNvCs9wFQrvczXsK_7___rustc14___rust_realloc_01813c00)
                      (auVar12._8_8_,uVar8 * lStack_b8,lVar7,uVar3,auVar12._8_8_,uVar8 * lStack_b8,
