// 004169d0  undefined _RNvMs3_NtCskPe9mFtgPYj_5alloc7raw_vecINtB5_6RawVecTctEE8grow_oneCs14svwdtrmj2_24tectonic_engine_spx2html(void)

void _RNvMs3_NtCskPe9mFtgPYj_5alloc7raw_vecINtB5_6RawVecTctEE8grow_oneCs14svwdtrmj2_24tectonic_engine_spx2html
               (ulong *param_1)

{
  ...
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs14svwdtrmj2_24tectonic_engine_spx2html_llvm_4308007309237878366
            (aiStack_28,*param_1,param_1[1],uVar11,4,8);
  if (aiStack_28[0] != 1) {
    param_1[1] = (ulong)puStack_20;
    *param_1 = uVar11;
    return;
  }
  puStack_30 = &UNK_00416a34;
  ...
  puStack_58 = &UNK_00416a7a;
  puStack_38 = param_1;
  puStack_30 = (undefined *)uVar11;
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs14svwdtrmj2_24tectonic_engine_spx2html_llvm_4308007309237878366
            (aiStack_50,*puStack_20,puStack_20[1],uVar10,4,4);
  if (aiStack_50[0] != 1) {
    puStack_20[1] = (ulong)puStack_48;
    *puStack_20 = uVar10;
    return;
  }
  puStack_58 = &UNK_00416aa4;
  puVar5 = puStack_48;
