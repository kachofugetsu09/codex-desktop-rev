// 00414f60  undefined _RNvMs3_NtCskPe9mFtgPYj_5alloc7raw_vecINtB5_6RawVecNtCs6jvT8GW1FjT_22tectonic_engine_bibtex4FileE8grow_oneBO_(void)

void _RNvMs3_NtCskPe9mFtgPYj_5alloc7raw_vecINtB5_6RawVecNtCs6jvT8GW1FjT_22tectonic_engine_bibtex4FileE8grow_oneBO_
               (ulong *param_1)

{
  ...
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs6jvT8GW1FjT_22tectonic_engine_bibtex_llvm_10926337731851813133
            (aiStack_28,*param_1,param_1[1],uVar11,8,0x20);
  if (aiStack_28[0] != 1) {
    param_1[1] = (ulong)puStack_20;
    *param_1 = uVar11;
    return;
  }
  puStack_30 = &UNK_00414fc4;
  ...
  puStack_58 = &UNK_0041500a;
  puStack_38 = param_1;
  puStack_30 = (undefined *)uVar11;
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs6jvT8GW1FjT_22tectonic_engine_bibtex_llvm_10926337731851813133
            (aiStack_50,*puStack_20,puStack_20[1],uVar10,8,0x10);
  if (aiStack_50[0] != 1) {
    puStack_20[1] = (ulong)puStack_48;
    *puStack_20 = uVar10;
    return;
  }
  puStack_58 = &UNK_00415034;
  puVar5 = puStack_48;
  ...
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs6jvT8GW1FjT_22tectonic_engine_bibtex_llvm_10926337731851813133
            (aiStack_78,*puVar5,puVar5[1]);
  if (aiStack_78[0] != 1) {
    puVar5[1] = (ulong)puStack_70;
    *puVar5 = uVar11;
    return;
  }
  puVar6 = puStack_70;
  ...
  if (lStack_68 == 0) {
    ...
    lVar4 = (*(code *)PTR__RNvCs9wFQrvczXsK_7___rustc14___rust_realloc_01813c00)
                      (auVar12._8_8_,uVar8 * lStack_68,lVar7,uVar3,auVar12._8_8_,uVar8 * lStack_68,
