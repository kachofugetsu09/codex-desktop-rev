// 00406d80  undefined _RNvMs3_NtCskPe9mFtgPYj_5alloc7raw_vecINtB5_6RawVecNtNtCs268jdzri8zx_3std7process7CommandE8grow_oneCs72o0HLIKWBT_8tectonic(void)

void _RNvMs3_NtCskPe9mFtgPYj_5alloc7raw_vecINtB5_6RawVecNtNtCs268jdzri8zx_3std7process7CommandE8grow_oneCs72o0HLIKWBT_8tectonic
               (ulong *param_1)

{
  ...
  puStack_30 = &UNK_00406dba;
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs72o0HLIKWBT_8tectonic_llvm_4467672155243684747
            (aiStack_28,*param_1,param_1[1],uVar10,8,200);
  if (aiStack_28[0] != 1) {
    param_1[1] = (ulong)puStack_20;
    *param_1 = uVar10;
    return;
  }
  puStack_30 = &UNK_00406de4;
  ...
  puStack_58 = &UNK_00406e2a;
  puStack_38 = param_1;
  puStack_30 = (undefined *)uVar10;
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs72o0HLIKWBT_8tectonic_llvm_4467672155243684747
            (aiStack_50,*puStack_20,puStack_20[1],uVar11,8,0x40);
  if (aiStack_50[0] != 1) {
    puStack_20[1] = (ulong)puStack_48;
    *puStack_20 = uVar11;
    return;
  }
  puStack_58 = &UNK_00406e54;
  ...
  puStack_80 = &UNK_00406e9a;
  puStack_58 = (undefined *)uVar11;
  _RNvMs4_NtCskPe9mFtgPYj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCs72o0HLIKWBT_8tectonic_llvm_4467672155243684747
            (aiStack_78,*puStack_48,puStack_48[1],uVar10,8,0x20);
  if (aiStack_78[0] != 1) {
    puStack_48[1] = (ulong)puStack_70;
    *puStack_48 = uVar10;
    return;
  }
  puStack_80 = &UNK_00406ec4;
  puVar5 = puStack_70;
